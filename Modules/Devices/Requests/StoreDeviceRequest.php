...
class StoreDeviceRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('devices.create') ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'community' => ['nullable', 'required_if:snmp_version,v2c', 'string', 'max:255'],
            ...
            'auth_password' => ['nullable', 'required_if:snmp_version,v3', 'string', 'max:255'],
