...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $defaults = [
            ...
            ['group' => 'general', 'key' => 'app_timezone', 'value' => 'Asia/Kolkata', 'type' => 'string', 'label' => 'Application Timezone', 'description' => 'Timezone used for charts and scheduling display (12-hour AM/PM).'],
